...
*/
pessoa.nomeCompleto(); // Olá! Meu nome é Juca Bala!
...
retornada)
*/
pessoa.mostrarIdade();   // Olá, eu tenho 35 ano!
...
// Agora, apresente-se ;)
pessoa.apresentação() // Olá, eu sou o Juca Bala, tenho 35 anos, 1.84, meu peso é 84 e, só hoje, eu já caminhei 350 metros!
```
